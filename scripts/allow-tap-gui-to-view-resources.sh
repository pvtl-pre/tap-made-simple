...
BUILD_CLUSTER_SA_TOKEN_PATH=".clusters.build_cluster.sa_token"
...
ITERATE_CLUSTER_SA_TOKEN_PATH=".clusters.iterate_cluster.sa_token"
...
for ((i = 0; i < $RUN_CLUSTER_COUNT; i++)); do
  ...
  RUN_CLUSTER_SA_TOKEN_PATH=".clusters.run_clusters[$i].sa_token"
